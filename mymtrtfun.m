...
% New RT function:
Prto = @(To,c0to,c1to,ntarg) ((1-(1/ntarg))./(1 + exp(-(c0to) - (c1to).*To))) + (1/ntarg); % n targets
...
% Orignial Utility
J=-(param.myalphascale * param.myalpha * Pr(Tr,param.myprobscale*param.myc0,param.myc1)*Prto(To,param.myc0to,param.myc1to,param.ntarg)...
