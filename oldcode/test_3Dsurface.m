...
figure;
heatmap(effscalemat, alphascalemat, totalsavings, C, 'FaceAlpha', 0.5);
xlabel('effort scale'); ylabel('reward scale'); zlabel('Total time savings (s)');
colorbar('Ticks',[0.7 1.05 1.4],'TickLabels',{'Low J' 'Moderate J' 'High J'});
colormap('spring');

% figure;
% heatmap(myeffscales, myalphascales, RTprops);
% xlabel('effort scale'); ylabel('reward scale'); 
% colormap('spring');
